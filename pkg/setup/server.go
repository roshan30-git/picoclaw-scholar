        ...
        <div class="glass-card">
            ...
            <form action="/save" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" id="TELEGRAM_BOT_TOKEN" name="TELEGRAM_BOT_TOKEN" placeholder="123456789:ABC..." aria-describedby="TELEGRAM_BOT_TOKEN_HINT" required>
                    <div id="TELEGRAM_BOT_TOKEN_HINT" class="hint">Get from @BotFather</div>
                </div>
                <div class="form-group">
                    <label for="STUDYCLAW_OWNER_NUMBER">Admin Phone Number</label>
                    <input type="text" id="STUDYCLAW_OWNER_NUMBER" name="STUDYCLAW_OWNER_NUMBER" placeholder="e.g. 919832XXXXXX" aria-describedby="STUDYCLAW_OWNER_NUMBER_HINT" required>
                    <div id="STUDYCLAW_OWNER_NUMBER_HINT" class="hint">With country code, no "+"</div>
                </div>
                <div class="form-group">
                    <label for="GEMINI_API_KEY">Gemini API Key (Optional)</label>
                    <input type="password" id="GEMINI_API_KEY" name="GEMINI_API_KEY" placeholder="AIzaSy..." aria-describedby="GEMINI_API_KEY_HINT">
                    <div id="GEMINI_API_KEY_HINT" class="hint">For fallback or direct vision features</div>
                </div>
