        ...
        <div class="glass-card">
            ...
            <form action="/save" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" id="TELEGRAM_BOT_TOKEN" name="TELEGRAM_BOT_TOKEN" placeholder="123456789:ABC..." required aria-describedby="TELEGRAM_BOT_TOKEN-hint">
                    <div class="hint" id="TELEGRAM_BOT_TOKEN-hint">Get from @BotFather</div>
                </div>
                <div class="form-group">
                    <label for="STUDYCLAW_OWNER_NUMBER">Admin Phone Number</label>
                    <input type="text" id="STUDYCLAW_OWNER_NUMBER" name="STUDYCLAW_OWNER_NUMBER" placeholder="e.g. 919832XXXXXX" required aria-describedby="STUDYCLAW_OWNER_NUMBER-hint">
                    <div class="hint" id="STUDYCLAW_OWNER_NUMBER-hint">With country code, no "+"</div>
                </div>
                <div class="form-group">
                    <label for="GEMINI_API_KEY">Gemini API Key (Optional)</label>
                    <input type="password" id="GEMINI_API_KEY" name="GEMINI_API_KEY" placeholder="AIzaSy..." aria-describedby="GEMINI_API_KEY-hint">
                    <div class="hint" id="GEMINI_API_KEY-hint">For fallback or direct vision features</div>
                </div>
