        ...
        <div class="glass-card">
            ...
            <form action="/save" method="POST">
                <div class="form-group">
                    ...
                    <div id="telegram-hint" class="hint">Get from @BotFather</div>
                </div>
                <div class="form-group">
                    <label for="STUDYCLAW_OWNER_NUMBER">Admin Phone Number</label>
                    <input type="text" id="STUDYCLAW_OWNER_NUMBER" name="STUDYCLAW_OWNER_NUMBER" placeholder="e.g. 919832XXXXXX" aria-describedby="phone-hint" required>
                    <div id="phone-hint" class="hint">With country code, no "+"</div>
                </div>
                <div class="form-group">
                    ...
                    <div id="gemini-hint" class="hint">For fallback or direct vision features</div>
                </div>
